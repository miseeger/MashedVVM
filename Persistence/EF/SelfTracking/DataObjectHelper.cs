...
namespace MashedVVM.Persistence.EF.Selftracking
{
    ...
    public static class DataObjectHelper
    {
        ...
        public static void ApplyObjectStatuss<T>(this ICollection<T> entities, DbContext dbContext) where T : IDataObject
        {
        ...
        public static void ApplyObjectStatus<T>(this T entity, DbContext dbContext) where T : IDataObject
        {
            switch (entity.ObjectStatus)
            {
                case DataObjectStatus.New:
                    dbContext.Entry<T>(entity).State = System.Data.EntityState.Added;
                    break;
                case DataObjectStatus.Changed:
        ...
        {
            entity.ObjectStatus = DataObjectStatus.Unchanged;
        }
